...
DEPS_conda = gcc gxx gfortran python pkgconfig cmake openmpi openmpi-mpicc
DEPS_conda += openmpi-mpicxx openmpi-mpifort gsl fftw gmp mpfr hdf5 netcdf4
DEPS_conda += libopenblas liblapack
